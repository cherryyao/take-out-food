...
const {buildFormattedItem,buildItemwithDetail,unDiscountTotal,ThirtyMinusSixSave,getSpceialItems,SpceialItemSave,selectPromotionProject} = require('../src/best-charge');
...
//7.选择优惠方案,0是没有优惠、1是满30-6、2是特价菜品
  it ('slect promotion project--selectPromotionProject()',function(){
    let currentSpceialItems =  [{name:"黄焖鸡",spceialtemsave:9},{name:"凉皮",spceialtemsave:4}];
